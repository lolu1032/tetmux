...
const (
	...
	ModeMouseX10
	ModeMouseMany
	// ModeBracketedPaste is set while the application has enabled bracketed
	// paste (DEC private mode 2004): pasted input should be wrapped in
	// ESC[200~ ... ESC[201~ so the app can tell a paste from typed keystrokes.
	ModeBracketedPaste
