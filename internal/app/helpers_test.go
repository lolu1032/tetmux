...
func TestToRouterKeySpecials(t *testing.T) {
	cases := []struct {
		...
		{"tab", tea.KeyMsg{Type: tea.KeyTab}, router.KeyOther, []byte{'\t'}},
		{"esc", tea.KeyMsg{Type: tea.KeyEsc}, router.KeyOther, []byte{0x1b}},
		...
		{"ctrl-c", tea.KeyMsg{Type: tea.KeyCtrlC}, router.KeyOther, []byte{0x03}},
